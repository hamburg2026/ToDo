...
export default function EdgeZone({ side, label, active }: Props) {
  ...
  return (
    <div
      ...
      style={side === 'left' ? { backgroundImage: isOver ? 'linear-gradient(to right, rgba(139,92,246,0.4), transparent)' : undefined } : undefined}
    >
      <div
      ...
      >
        ...
        <span
          className="whitespace-nowrap text-[11px] font-semibold uppercase tracking-wider text-white/70"
