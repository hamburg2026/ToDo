        ...
        <div className="space-y-2">
          {CARD_FONT_OPTIONS.map((option) => {
            ...
            return (
              ...
              >
                <div>
                  <p className={`${CARD_FONT_CLASSES[option.id]} text-lg font-medium text-[#151f76]`}>Aufgabe erledigen</p>
        ...
        <div className="grid grid-cols-3 gap-2">
          {CARD_FONT_SIZE_OPTIONS.map((option) => {
            ...
            return (
              ...
              >
                <span className={`${CARD_FONT_CLASSES[cardFont]} ${CARD_FONT_SIZE_CLASSES[option.id].title} font-medium text-[#151f76]`}>
                  Aa
                </span>
